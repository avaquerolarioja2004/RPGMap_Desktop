...
namespace RPGMap
{
    public partial class PopUpInformacion : Form
    {
        ...
        private void SetInfoLabelText()
        {
            ...
            {
                case 'R':
                    info.Text = "PARA AÑADIR UNA SALA DEBES DE SELECIONAR EL ALTO Y EL ANCHO HACIENDO USO DE LA CUADRICULA ARRASTRANDO EL CURSOR PARA SELECCIONARLO.";
                    break;
                case 'O':
                ...
                case 'F':
                    ...
                    break;
                case 'E':
                    info.Text = "PARA AÑADIR UN ENEMIGO DEBES DE DARLE UN NOMBRE, ELEGIR UNA DIFICULTAD Y AÑADIR UNA IMAGEN PARA QUE APAREZCA EN EL MAPA, HACIENDO CLICK EN EL BOTÓN DE AÑADIR.";
                    break;
            }
        }
